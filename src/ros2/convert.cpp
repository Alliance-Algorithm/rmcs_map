...
void ros2::convert::livox_to_pcl(const std::vector<livox_ros_driver2::msg::CustomPoint>& livox, pcl::PointCloud<pcl::PointXYZ>& pcl)
{
...
void ros2::convert::pcl_to_pc2(const pcl::PointCloud<pcl::PointXYZ>& pcl, sensor_msgs::msg::PointCloud2& pc2)
{
